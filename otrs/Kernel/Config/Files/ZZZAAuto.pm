...
$Self->{'AgentLoginLogo'} =  {
  'StyleHeight' => '150px',
  'URL' => 'skins/Agent/default/img/logocne2.png'
};
$Self->{'AgentLogo'} =  {
  'StyleHeight' => '80px',
  'StyleRight' => '0px',
  'StyleTop' => '10px',
  'StyleWidth' => '200px',
  'URL' => 'skins/Agent/default/img/logocne.png'
};
...
$Self->{'CustomerFrontend::Module'}->{'DevelFred'} =  {
  'Description' => 'Admin',
  'Group' => [],
  'GroupRo' => [],
  'NavBarName' => 'Admin',
  'Title' => 'Fred-Developertools'
};
...
$Self->{'DashboardBackend'}->{'0130-TicketOpen'} =  {
  'Attributes' => 'StateType=open;SortBy=EscalationSolutionTime;OrderBy=Up;',
  'Block' => 'ContentLarge',
  'CacheTTLLocal' => '0.5',
  'Default' => '1',
  'DefaultColumns' => {
...
$Self->{'Fred::Active'} =  0;
$Self->{'Fred::BackgroundColor'} =  '#D63535';
$Self->{'Fred::ConfigLog'}->{'OrderBy'} =  '3';
$Self->{'Fred::ConfigSwitch'}->{'Settings'} =  [
  'Frontend::RichText',
  'Frontend::DebugMode',
...
$Self->{'Fred::ConsoleOpacity'} =  '0.9';
$Self->{'Fred::ConsoleWidth'} =  '50%';
$Self->{'Fred::Module'}->{'ConfigLog'} =  {
  'Active' => '0',
  'Description' => 'Lists all configuration items which were used in this call (and how often they were called).'
};
$Self->{'Fred::Module'}->{'ConfigSwitch'} =  {
  'Active' => '0',
  'Description' => 'Switch on or off some often needed config items directly in Fred.'
};
$Self->{'Fred::Module'}->{'Console'} =  {
  'Active' => '1'
};
$Self->{'Fred::Module'}->{'EnvDump'} =  {
  'Active' => '0',
  'Description' => 'Dumps out all environment variables.'
};
$Self->{'Fred::Module'}->{'HTMLCheck'} =  {
  'Active' => '0',
  'Description' => 'Validates the HTML in this call.'
};
$Self->{'Fred::Module'}->{'JSLint'} =  {
  'Active' => '0',
  'Description' => 'Validates the JS in this call and shows errors and notices.'
};
$Self->{'Fred::Module'}->{'SQLLog'} =  {
  'Active' => '0',
  'Description' => 'Shows a list of all SQL statements executed in this call.'
};
$Self->{'Fred::Module'}->{'STDERRLog'} =  {
  'Active' => '0',
  'Description' => 'Lists entries from the STDERR log.'
};
$Self->{'Fred::Module'}->{'SessionDump'} =  {
  'Active' => '0',
  'Description' => 'Dumps out all session variables.'
};
$Self->{'Fred::Module'}->{'TranslationDebug'} =  {
  'Active' => '0',
  'Description' => 'Shows a list of untranslated strings. Please note that strings from framework AND custom modules will be shown.'
};
$Self->{'Fred::STDERRLogFilter'} =  ': [ ] Subroutine [ ] [_a-zA-Z0-9]+ [ ] redefined [ ] at [ ] .+ [ ] line [ ] \\d+ \\.';
$Self->{'Fred::SystemName'} =  '';
...
$Self->{'Frontend::Module'}->{'DevelFred'} =  {
  'Description' => 'Admin',
  'Group' => [],
  'GroupRo' => [],
  'NavBarName' => 'Admin',
...
$Self->{'Frontend::Output::FilterContent'}->{'Fred'} =  {
  'Debug' => '0',
  'Module' => 'Kernel::Output::HTML::FilterContent::Fred',
  'Templates' => {
    'ALL' => '1'
  }
};
...
$Self->{'Loader::Agent::CommonCSS'}->{'000-Fred'} =  [
  'Core.Fred.css'
];
...
$Self->{'Loader::Agent::CommonJS'}->{'000-Fred'} =  [
  'thirdparty/jslint/jslint.js',
  'Core.Fred.js',
  'Core.Fred.JSLint.js',
  'Core.Fred.HTMLCheck.js'
];
...
$Self->{'Loader::Customer::CommonCSS'}->{'000-Fred'} =  [
  'Core.Fred.css'
];
...
$Self->{'Loader::Customer::CommonJS'}->{'000-Fred'} =  [
  'thirdparty/jslint/jslint.js',
  'Core.Fred.js',
  'Core.Fred.JSLint.js',
  'Core.Fred.HTMLCheck.js'
...
$Self->{'OTRSTimeZone'} =  'America/Caracas';
$Self->{'OnlyValuesOnTicket'} =  '1';
$Self->{'OpenMainMenuOnHover'} =  0;
$Self->{'Organization'} =  'CNS';
...
$Self->{'PublicFrontend::Module'}->{'DevelFred'} =  {
  'Description' => 'Admin',
  'Group' => [],
  'GroupRo' => [],
  'NavBarName' => 'Admin',
...
$Self->{'Ticket::EventModulePost'}->{'3100-LockAfterCreate'} =  {
...
$Self->{'Ticket::Frontend::TextAreaNote'} =  '20';
...
$Self->{'UserDefaultTimeZone'} =  'America/Caracas';
